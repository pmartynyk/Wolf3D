...
{
	if (wolf3d->map[(int)(wolf3d->player->start_y)][(int)(wolf3d->player->start_x + wolf3d->player->dir_x * (wolf3d->camera->move_speed + 0.5))] != 1)
...
static void	ft_right(t_wolf3d *wolf3d)
{
	...
	wolf3d->player->dir_x = wolf3d->player->dir_x *	cos(wolf3d->camera->rotate_speed) - wolf3d->player->dir_y * sin(wolf3d->camera->rotate_speed);
	wolf3d->player->dir_y = old_dir_x * sin(wolf3d->camera->rotate_speed) + wolf3d->player->dir_y * cos(wolf3d->camera->rotate_speed);
